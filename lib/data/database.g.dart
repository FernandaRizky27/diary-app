...
class $DiaryTable extends Diary with TableInfo<$DiaryTable, DiaryData> {
  ...
  static const VerificationMeta _content_dateMeta =
      const VerificationMeta('content_date');
  @override
  late final GeneratedColumn<DateTime> content_date = GeneratedColumn<DateTime>(
      'content_date', aliasedName, false,
  ...
  List<GeneratedColumn> get $columns =>
      [id, title, content, content_date, createdAt, updatedAt, deletedAt];
  @override
  ...
  VerificationContext validateIntegrity(Insertable<DiaryData> instance,
    ...
    if (data.containsKey('content_date')) {
      context.handle(
          _content_dateMeta,
          content_date.isAcceptableOrUnknown(
              data['content_date']!, _content_dateMeta));
    } else if (isInserting) {
      context.missing(_content_dateMeta);
    }
  ...
  DiaryData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DiaryData(
      ...
      content_date: attachedDatabase.typeMapping
          .read(DriftSqlType.dateTime, data['${effectivePrefix}content_date'])!,
...
class DiaryData extends DataClass implements Insertable<DiaryData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['content_date'] = Variable<DateTime>(content_date);
  ...
  factory DiaryData.fromJson(Map<String, dynamic> json,
    ...
    return DiaryData(
      ...
      content_date: serializer.fromJson<DateTime>(json['content_date']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'content_date': serializer.toJson<DateTime>(content_date),
  ...
  DiaryData copyWith(
      ...
      DiaryData(
        ...
        content_date: content_date ?? this.content_date,
  ...
  String toString() {
    return (StringBuffer('DiaryData(')
          ...
          ..write('content_date: $content_date, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is DiaryData &&
          ...
          other.content_date == this.content_date &&
...
class DiaryCompanion extends UpdateCompanion<DiaryData> {
  ...
  final Value<DateTime> content_date;
  ...
  const DiaryCompanion({
    ...
    this.content_date = const Value.absent(),
  ...
  DiaryCompanion.insert({
    ...
    required DateTime content_date,
  ...
  static Insertable<DiaryData> custom({
    ...
    Expression<DateTime>? content_date,
    ...
    return RawValuesInsertable({
      ...
      if (content_date != null) 'content_date': content_date,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (content_date.present) {
      map['content_date'] = Variable<DateTime>(content_date.value);
    }
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [diary, note];
}
